...
menu() {
    ...
    echo -e "  ${CIANO}3)${SEM_COR} Configurar IP, Senha e Nome do Server"
    echo -e "  ${CIANO}4)${SEM_COR} Verificar/Criar campo 'email' na DB"
    echo -e "  ${CIANO}5)${SEM_COR} Criar Usuário GM (Admin)"
    echo -e "  ${CIANO}6)${SEM_COR} Adicionar Notícias ao Launcher"
    echo -e "  ${CIANO}7)${SEM_COR} Gerar Arquivos de Update"
    ...
    case $OPCAO in
        ...
        3) bash /home/talisman/.talisman-tools/config_ip_e_senha_server_talisman.sh ;;
        4) bash /home/talisman/.talisman-tools/email.sh ;;
        5) bash /home/talisman/.talisman-tools/criar_gm.sh ;;
        6) bash /home/talisman/.talisman-tools/gerar_news_update.sh ;;
        7) python /home/talisman/.talisman-tools/gerar_patch_update.py ;;
        8) bash /home/talisman/.talisman-tools/ligar_server_ubuntu_10.sh ;;
        9) bash /home/talisman/.talisman-tools/desligar_server_ubuntu_10.sh ;; # Nova Opção!
        0) exit 0 ;;
