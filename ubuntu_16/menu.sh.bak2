...
menu() {
    ...
    echo -e "  ${CIANO}7)${SEM_COR} LIGAR SERVIDOR (DB, Login e Game)"
    echo -e "  ${CIANO}8)${SEM_COR} DESLIGAR SERVIDOR"
    ...
    case $OPCAO in
        ...
        7) bash /home/talisman/.talisman-tools/ligar_server_ubuntu_16.sh ;;
        8) bash /home/talisman/.talisman-tools/desligar_server_ubuntu_16.sh ;; # Nova Opção!
        0) exit 0 ;;
